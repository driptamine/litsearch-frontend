import{j as t,x,d as n}from"./index-e7baabdf.js";import{L as f}from"./LikeIcon-5d6e3eec.js";const h=({isLiked:o,likesCount:l,onClick:s,size:a=18,showCount:c=!0,activeColor:e=x,inactiveColor:i="#71767b",hoverColor:p="#1d9bf0"})=>{const u=r=>{r.preventDefault(),r.stopPropagation(),s&&s()};return t.jsxs(L,{onClick:u,active:o,activeColor:e,hoverColor:p,inactiveColor:i,children:[t.jsx(f,{size:a,color:o?e:"currentColor",fill:o?e:"none"}),c&&t.jsx(v,{children:l||0})]})},k=o=>`
