  ...
  useEffect(() => {
    ...
    const setValue = () => {
      ...
      const newValue2 = Number(
        ((rangeWeight.value - rangeWeight.min) * 100) /
          (rangeWeight.max - rangeWeight.min)
      );
  ...
  return (
    <div className="range">
      ...
      <div className="range-wrap">
        <div className="range-value" id="bubbleHeight">
      ...
      <div className="range-wrap">
        <div className="range-value" id="bubbleWeight">
