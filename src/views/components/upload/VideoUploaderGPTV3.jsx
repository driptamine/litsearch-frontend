...
const VideoUploaderGPT = () => {
  ...
  const visualProgressRef = useRef(0); // 🔑 Track actual visual progress
  ...
  const simulateInitialProgress = (target = 20, speed = 200) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      // Step 1: Simulate progress to 60%
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        <progress value={progress} max="100" style={{ width: "100%", accentColor: "#673ab7" }} />
        <div>{progress}%</div>
      </div>
