...
export default function* rootSaga() {
  yield all([
     watchFetchAlbum,
    //  watchFetchPopularAlbums,
     watchFetchLikeAlbum,
     watchFetchUnLikeAlbum,

     watchFetchArtist,
     watchFetchArtistAlbums,
     watchFetchArtistImages,
     ...
     watchFetchMovieCredits,
     watchFetchMovieVideos,


     watchFetchPerson,
     watchFetchPopularPeople,
     watchFetchPersonImages,
     watchFetchPersonCredits,
    //  watchFetchGenres,


     watchFetchPlaylist,
     watchFetchOffsetPlaylist,
     ...
     watchFetchSearch,
     watchFetchQuerySearch(),


     watchFetchMovieSearch,
     watchFetchPersonSearch,

     watchFetchArtistSearch,
     watchFetchAlbumSearch,
     watchFetchTrackSearch,
